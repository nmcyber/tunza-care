  ...
  return (
    ...
    <div className=" flex max-w-6xl mx-auto md:flex-row items-center justify-between p-0">
      ...
      <div className="md:w-1/2 space-y-2">
        ...
        >
          Quality <span className=" text-sky-700">Home Healthcare</span> You Can
          Trust.
        </motion.h1>
        <p className="text-gray-600">
          Tunza Care Services is a WA NDIS provider, offering a range of in-home
          care, community participation, supported independent living, clinical
          care and allied health services across Western Australia.
        </p>
      ...
      <div className="relative md:w-1/2">
        ...
        >
          ...
          <div className="">
            <p className="text-sm font-medium text-gray-700 p-1">Health Control</p>
            <p className="text-xs text-gray-500 p-1">Lorem Ipsum is simply dummy </p>
