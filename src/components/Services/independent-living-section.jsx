          ...
          <CardContent className="p-0">
            ...
            <div className='flex flex-col md:flex-row gap-8 rounded-lg bbg-[#f8f9fa]'>
              ...
              <div className="grid justify-items-start items-start w-full outline-0 outline-emerald-600 lg:w-1/2 px-4 pt-4 pb-6 md:px-8 md:py-4 bg-[#f8f9fa] overflow-hidden rounded-lg ">
                ...
                arrangement.<br/>{' '}Tunza Care will help you have that choice and control of who to live with, where to live
                and how you want to live.<br/>{' '}The support team will help you to:
              </Typography>
                </div>
                <>
                  {/* Services list with checkmarks */}
              ...
              <div id='house-image'
                ...
                {/* <div className='w-full scale-110 rounded-bl-xl h-full absolute inset-0 z-10 bg-white' /> */}

                {/* <div className=' absolute -top-2 -left-14 w-8 aspect-sqaure bg-radial-[at_100%_100%] border-0 outline-0 from-white to-white aspect-square bg-transparent z-30 shadow-[-0.5rem_0_0_1]' style={{
              backgroundImage: 'radial-gradient(circle at 0% 100%, transparent 1.45rem, white, white calc(1.4rem + 1px))' }} /> */}
              <img
